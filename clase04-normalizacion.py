...
'''
#----------------------------------------------------------------------------------------------------------------------------------------------------
#OPTIMIZACION DEL QUERY
#https://www.youtube.com/watch?v=CG71cLEd7LA
#VER EN LA SALIDA DE LA TABLA EN EXECUTION PLAN
#ALLI PODEMOS VER EL COSTO POR CONSULTA
...
# El n1 es cuando tengo mas de un campo o mas de un elemento en una columna. el problema tambien se puede dar al reves, donde tenga mas columnas de las necesarias
# no podemos combinar informacion en una sola columna
#no mezclar tipos de datos en una columna


#? N2
# el n2 se da cuando en una tabla (de hecho), generalmente se dan redundancias. como por ejemplo
# poner el id de clientes   en la tabla de ventas y poner la diireccion 

#Segunda forma normal (2NF)
#Este siguiente conjunto de reglas se basa en las descritas en 1NF.
#Cumple con todas las reglas de 1NF
#Quitar datos que no dependan de la clave principal de la tabla (mover los datos a la tabla adecuada o crear una nueva tabla y clave principal)
#Las claves externas se utilizan para identificar las relaciones de tabla


#? N3

#Este conjunto de reglas lleva las descritas en 1NF y 2NF un paso más allá.
#Cumple con todas las reglas de 1NF y 2NF
#Quitar atributos que dependen de otros atributos que no son clave (es decir, quitar columnas que dependen de columnas que no son claves externas o primarias)
#? solamente tener una foreign key de cada tabla, pero no agregar atributos redundantes


#? N4
# evitar dependencias multivaluadas


#----------------------------------------------------------------------------------------------------------------------------------------------------
#  indices en sql
# cuando creamos un clave primaria, sql crea automaticamente un indice para cada fila, que mejora el rendimiento
# https://www.youtube.com/watch?v=y1TxR53RlYU

#para verificar si una tabla tiene indice: 
#? execute sp_helpindex 'tabla' ---> procedure
# tengo que ver si me combiene poner indice. por ejemplo pensar en los joins
#por ejemplo si uso mucho un campo determinado, por ejemplo trimestre. ya que no es una clave foranea puede que me convenga
# tambien en fk y pk
# con el constrain logro la referencia
#agrefar una fk con restriccion me da seguridad
#por que despues no puedo borrar una fk
#el objetivo es garantizar integridad referencia entre tablas


#----------------------------------------------------------------------------------------------------------------------------------------------------
#  TABLAS DE HECHOS Y TABLAS DE DIMENSIONES
# https://www.youtube.com/watch?v=Tn9ZTR6M7dQ
#LAS TABLAS DE HECHOS REGISTRAN EVENTOS, GENERALMENTE EN UNA FECHA DETERMINADA. SUELEN TENER MUCHOS FK
# las tablas de dimensiones, generalmente detallan las caracteristicas de los sujetos que participan en la tabla de hecho


#modelos estrellas son simples, generalmente la tabla de hechos esta en el medio. y las de dimensiones las rodean
# la tabla de copo de nueves, sus tablas de dimensiones tieien a su vez otras tablas de dimensiones anidadas.

#----------------------------------------------------------------------------------------------------------------------------------------------------
#  modo transaccion
#https://www.youtube.com/watch?v=HsAsyo6Lxx8
# https://www.youtube.com/watch?v=xe9eYThkOmw
# https://www.youtube.com/watch?v=xbedZg38dy4
#https://www.youtube.com/watch?v=xbedZg38dy4   >>> mejor video

#el modo transaccion es codigo ejecutado todo al mismo tiempo. lo confirmamos con un commit
#volvemos atras con un rollback
# para verlo de forma grafico

#1_ inicio de la transaccion
#2 hago toda las modificaciones que deba hacer
#3 commit

# el resultado es el mismo que sin transacciones cuando las cosas van bien, cuando las cosas van mal, no puedo ir atras si no estoy en transaccion
# VAMOS A USAR EL MODO TRANSACCION CUANDO QUERAMOS HACER CAMBIOS EN LA BASE DE DATOS PERO DE FORMA SEGURA

#IMPORTANTE ---> EL MODO TRANSACCION EJECUTA TODO AL MISMO TIEMPO O NADA
#SINTAXIS
...
#https://www.youtube.com/watch?v=OnzXpzzKSOw



#------------------------------------------------------------------------------------------------------------------------------------------------------
#claves sugrogadas
#https://www.youtube.com/watch?v=chsnbo8Kaoc
#una clave subrogada es una clave combinada
